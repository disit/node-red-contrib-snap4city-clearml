...
module.exports = function (RED) {
    ...
    function Snap4cityAuthenticationClearML(config) {
        ...
        this.refreshTokenGetAccessToken = function (uid) {
            ...
            xmlHttp.send(params);
            logger.info("xmlHttp.responseText: " + xmlHttp.responseText);
            if (xmlHttp.responseText != "") {
                try {
                    response = JSON.parse(xmlHttp.responseText);
    ...
    RED.nodes.registerType("snap4city-authentication-clearml", Snap4cityAuthenticationClearML, {
        credentials: {
            user: {
                type: "text"
            },
